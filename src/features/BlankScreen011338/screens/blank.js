...
export class __Blank extends React.Component {
  ...
  state = { Datepicker_4: new Date("09/29/2020"), Toggle_8: true }
  render = () => (
    <View style={this.props.themedStyle.View_1}>
      ...
      <Datepicker
        style={this.props.themedStyle.Datepicker_4}
      ...
      <Slider
        ...
        style={this.props.themedStyle.Slider_5}
      />
      <Image
        resizeMode="cover"
        source={{
        ...
        style={this.props.themedStyle.Image_6}
      />
      <Toggle
        text="switch ON/OFF"
        activeColor="#409EFF"
